...
if __name__ == "__main__":
    print("Running test_load_shift_recommendations_returns_savings_and_carbon_values...")
    test_load_shift_recommendations_returns_savings_and_carbon_values()
    print("Running test_anomaly_detection_flags_high_usage...")
    test_anomaly_detection_flags_high_usage()
    print("Running test_carbon_calculation_returns_value_in_kg...")
    test_carbon_calculation_returns_value_in_kg()
    print("All backend/test_insights.py tests passed successfully!")
